...
export const NoteTitle = ({
  ...
  if (!active) {
    return (
      <button
        ...
        className={cn(
          "mb-2 w-full truncate rounded-sm px-1 py-0.5 text-left text-xl font-semibold tracking-tight",
  ...
  return (
    <input
      ...
      className={cn(
        "mb-2 w-full rounded-sm border-b bg-transparent px-1 py-0.5",
        "text-xl font-semibold tracking-tight focus-visible:outline-none",
      )}
    />
  );
};
