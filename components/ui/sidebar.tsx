...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        // min-w-0: without it the inset's automatic minimum width is its
        // content's min-content size, so one long unbroken word in a note
        // widens the inset past the viewport and scrolls the whole page.
